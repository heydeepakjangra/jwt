...
const structuredData = {
  ...
  "@type": "WebApplication",
  "name": "JWT Tool",
  "description": "Professional JWT (JSON Web Token) toolkit for developers. Decode, generate, verify JWT tokens with support for all algorithms.",
  ...
  "featureList": [
    ...
    "Token Vault Storage",
    "Support for all JWT algorithms (HS256, HS384, HS512, RS256, RS384, RS512, ES256, ES384, ES512, PS256, PS384, PS512, EdDSA)",
